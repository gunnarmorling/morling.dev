---
title: "Projects"
date: 2026-02-27T19:40:00+02:00
draft: false
type: "page"
markup: adoc
---
...
https://github.com/hardwood-hq/hardwood[Hardwood] is a parser for the Apache Parquet file format, optimized for minimal dependencies (no Hadoop, IYKYK) and great performance, applying some of the learnings from 1BRC.
...
Persistasaurus::
https://github.com/gunnarmorling/persistasaurus[Persistasaurus] is a PoC of a durable execution engine backed by SQLite.
It allows to define multi-step workflows in Java using a simple annotation-based programming model,
with SQLite used for persisting the execution log.
If a flow gets interrupted, for instance due to a machine failure, Persistasaurus can resume it from the last successfully executed step.
You can learn more about it in https://www.morling.dev/blog/building-durable-execution-engine-with-sqlite/[this blog post].
