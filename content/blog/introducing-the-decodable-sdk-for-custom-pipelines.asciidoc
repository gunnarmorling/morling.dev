...
_This post originally appeared on the link:https://www.decodable.co/blog/introducing-the-decodable-sdk-for-custom-pipelines[Decodable blog]. All rights reserved._
...
mvn archetype:generate \
  ...
  -DgroupId=com.example.decodable \
  -DartifactId=my-first-decodable-custom-pipeline \
  -Dversion=0.1 \
  -Dpackage=com.example.custompipeline \
...
decodable pipeline create \
  ...
  --job-file target/my-first-decodable-custom-pipeline-0.1.jar
----
