...
These event streams enable a link:/blog/seven-ways-to-put-cdc-to-work[large variety of use cases], such as low-latency data feeds for analytical data stores, cache updates, full-text search indexes, and many more.
...
----
_Listing 1: Configuration of the Postgres source connector_
...
----
_Listing 2: Configuration of the Kafka sink connector_
...
INSERT INTO customers_public
  ...
  FROM customers;
----
_Listing 3: Flink SQL job for transforming the source table into the sink table_
