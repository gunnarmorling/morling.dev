...
Row filters can come in very handy to exclude portions of the operational data set from replication, for example test data or logically deleted data. You can learn more about row filters in link:/blog/postgres-15-logical-decoding-row-filters-with-debezium[this post] I wrote after Postgres 15 was released.
