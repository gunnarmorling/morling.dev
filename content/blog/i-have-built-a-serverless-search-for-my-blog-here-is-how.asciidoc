...
_Many thanks to https://twitter.com/hpgrahsl[Hans-Peter Grahsl] for his feedback while writing this post!_

TODO: Note on RAM / Siege with 512 MB
No spend capping, no quota for cors preflight
