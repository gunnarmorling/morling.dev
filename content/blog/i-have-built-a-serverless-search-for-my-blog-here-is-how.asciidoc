...
The implementation of that is fairly standard JavaScript business using the https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest[XMLHttpRequest] API,
