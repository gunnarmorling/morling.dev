...
_This post originally appeared on the link:https://www.decodable.co/blog/postgres-15-logical-decoding-row-filters-with-debezium[Decodable blog]. All rights reserved._
