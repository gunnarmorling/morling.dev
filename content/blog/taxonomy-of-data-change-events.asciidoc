...
[NOTE]
====
_Data Change Events and Apache Kafka_
...
image::taxonomy-of-data-change-events-1.png[]
...
image::taxonomy-of-data-change-events-2.png[]
...
image::taxonomy-of-data-change-events-3.png[]
...
But you also can employ stream processing to great effect for other CDC-related tasks, for instance for establishing stable data contracts for your change events streams, as I've discussed in link:/blog/change-data-capture-breaks-encapsulation-does-it-though[another blog post] not too long ago.
