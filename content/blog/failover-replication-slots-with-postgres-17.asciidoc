...
These subscribers can be other Postgres instances, as well as non-Postgres tools, such as Debezium, which use logical replication for link:https://rmoff.net/2024/10/15/why-do-i-need-cdc/[change data capture (CDC)].
