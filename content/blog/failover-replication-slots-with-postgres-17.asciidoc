...
_This post originally appeared on the link:https://www.decodable.co/blog/failover-replication-slots-with-postgres-17[Decodable blog]. All rights reserved._
...
.Postgres data change events in the Decodable stream preview
image::failover-slots-2.png[]

Now let's simulate a failover from primary to replica server and see how the failover of the replication slot is handled.
