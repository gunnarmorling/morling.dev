...
I've discussed this feature in great detail in link:/blog/stand-by-servers-for-postgres-logical-replication[this post].
Back then, link:/blog/logical-replication-from-postgres-stand-by-servers-debezium-and-failover-slots[I also explored] how to use replication slots on replicas for manually implementing replication slot failover.
