...
A much better solution is to retrieve link:https://www.decodable.co/blog/why-do-i-need-cdc#the-best-way-to-do-cdc-is-log-based-cdc[the outbox events via log-based CDC].
