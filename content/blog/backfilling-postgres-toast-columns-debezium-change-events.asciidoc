...
Such large values are commonly found when dealing with unstructured text, or when storing non-textual media blobs, for instance for multi-modal AI use cases. 
...
_Many thanks to Steffen Hausmann for his feedback while writing this post!_
