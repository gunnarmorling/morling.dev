...
.pyflink_hello_world.py (link:https://github.com/decodableco/examples/blob/main/pyflink/pyflink_hello_world.py[source])
...
.Dockerfile.pyflink-base (link:https://github.com/decodableco/examples/blob/main/pyflink/Dockerfile.pyflink-base[source])
[source,shell,linenums]
----
FROM flink:1.18.0
...
.Dockerfile (link:https://github.com/decodableco/examples/blob/main/pyflink/Dockerfile[source])
[source,shell,linenums]
----
...
.pyflink-hello-world.yaml (link:https://github.com/decodableco/examples/blob/main/pyflink/pyflink-hello-world.yaml[source])
